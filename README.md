...
On Linux/macOS: First, make the script executable (chmod +x start.sh), then run ./start.sh.

💥 Wipe Modes Explained
🐇 Quick Wipe: Fast but insecure. Deletes files, but they can be recovered.

🛡️ Secure Wipe (Recommended): Overwrites all data once. Defeats all software recovery tools.
